...
import com.sample.heartrateapp.service.BluetoothLeService;
import com.sample.heartrateapp.util.GattHeartRateAttributes;
...
//                locationService.close();
                ...
                public boolean onChildClick(ExpandableListView parent, View v, int groupPosition,
                    ...
                    if (gattCharacteristicsModel != null) {
                        ...
                        if ((charaProp | BluetoothGattCharacteristic.PROPERTY_NOTIFY) > 0) {
                            Log.d("TECH", ""+characteristic.getUuid());
                            Log.d("TECH", ""+characteristic.getProperties());
                            Log.d("TECH", ""+characteristic.getPermissions());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.tcp_btn).setOnClickListener(new View.OnClickListener() {
            @Override
